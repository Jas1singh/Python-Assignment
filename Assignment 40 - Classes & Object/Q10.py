...
class ExpenseTracker:
    ...
    def set(self, pname, msalary, rent, fexpenses,texpenses, other):
        self.person_name = pname
        self.monthly_salary = msalary
        self.rent = rent
        self.food_expenses = fexpenses
        self.travel_expenses = texpenses
        self.other_expenses = other
...
e = ExpenseTracker()
e.set("Rahul", 60000, 12000, 8000, 5000, 3000)
