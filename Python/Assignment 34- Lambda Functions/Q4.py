...
marks = list(map(int, input(f"Enter values: ").split()))

eligible = list(filter(lambda x:x>=75,marks))
print(eligible)

updated = list(map(lambda x:x+5,eligible))

finalMarks = sorted(updated,reverse=True)
print("Updated Salaries",finalMarks)
